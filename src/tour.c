...
extern "C"
{
    ...
    /* Six pre-defined, closed, structured knight's paths. */
        ...
        else
        {
            ...
            *pointAttribute_p = 8;
            ...
            do
            {
                ...
                *pointAttribute_p =
                    blkChoiceX == 1 && blkChoiceY == 1 && gridLocX == gridSizeX - 3 && gridLocY == gridSizeY - 1 ? 0 : blkChoiceX == 1 && blkChoiceY == 1 && gridLocX == gridSizeX - 1 && gridLocY == gridSizeY - 2 ? 1
                                                                                                                   ...
                                                                                                                   : blkChoiceX == 1 && blkChoiceY == 2 && gridLocX == gridSizeX - 1 && gridLocY == 0               ? 7
                                                                                                                                                                                                                    : *pointAttribute_p;
        ...
        unsigned int *next_a_offsetType_p, unsigned int *next_b_offsetType_p)
    {
        ...
        { /* Grid size must always meet one of the designated grid sizes */
#ifdef DEBUG
